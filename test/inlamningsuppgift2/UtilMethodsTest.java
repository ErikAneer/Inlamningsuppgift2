...
public class UtilMethodsTest {
         ...
         public final void isCurrentMemberTest(){
                    TestCase.assertTrue(u.checkIfCurrentMember(c) == true);
                    TestCase.assertFalse(u.checkIfCurrentMember(c) == false);
         }
         ...
         @Test public final void printMessageForNonMemberTest() {
                  ...
                  String expectedOutputMessage = "Det namn eller personnummer som har angetts matchar ingen tidigare registrerad kund."
                                           + "\nFörsök igen och kontrollera att du skrev in rätt eller testa ange personnummer eller namn istället."
                                           + "\nEller se till att personen skriver in sig på gymmet.";
